/**
 * Иконки устройств (микрофон/камера), общие для панели управления (`Controls`)
 * и блока устройств в форме входа (`DeviceToggles`). Вынесены отдельно, чтобы не
 * дублировать SVG.
 */
...
/** Иконка динамика/вывода звука (lucide volume-2). */
...
/** Иконка выключенного вывода звука (lucide volume-x). */
